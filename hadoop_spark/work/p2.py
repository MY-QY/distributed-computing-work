...
mid_pairs = parent_child_pairs.flatMap(lambda pair: [(pair[1], pair[0], 1), (pair[0], pair[1], 0)])
...
res_pairs = grouped_pairs.flatMap(lambda group: [(pair2[1], pair1[1]) for pair1 in group[1] for pair2 in group[1] if pair1[2] == 1 and pair2[2] == 0])
